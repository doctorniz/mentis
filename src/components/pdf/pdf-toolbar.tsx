  ...
  return (
    <>
      ...
      >
        ...
        <ToolBtn title="Previous page" onClick={() => setCurrentPage(Math.max(0, currentPage - 1))}>
      ...
      {activeTool === PdfTool.Text && (
        <div
          ...
          aria-live="polite"
        >
          <span className="text-fg-secondary font-medium">Text box:</span> Choose a text colour in
          the toolbar, then click a page to place. The tool switches to{' '}
          <span className="text-fg font-medium">Select</span> — drag the box to move;{' '}
          <span className="text-fg font-medium">double-click</span> to type or edit.
        </div>
      )}
    </>
  )
